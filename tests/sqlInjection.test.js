...
describe("🔐 SQL Injection Protection Tests", () => {
    test("🚨 Should prevent SQL injection attack in search", async () => {
        ...
        expect(res.body).toHaveProperty("error", "Invalid input detected in query parameters"); // ✅ Match the actual response
    });
    ...
    test("🚨 Should prevent SQL injection in ID parameter", async () => {
        ...
        expect(res.body).toHaveProperty("error", "Invalid input detected in route parameters"); // ✅ Match the actual response
    });
});
